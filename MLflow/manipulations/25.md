Voici le code mis à jour pour votre script, en suivant la même structure pour faciliter l'enregistrement de l'expérience dans MLflow avec les paramètres spécifiés.
