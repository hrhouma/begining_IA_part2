Voici le script amélioré avec l'ajout d'une évaluation basée sur un modèle de base et des seuils de validation pour la comparaison entre le modèle ElasticNet et le modèle de base `DummyRegressor`.
