Voici le code mis à jour pour une intégration complète avec MLflow, en ajoutant l'enregistrement du modèle ainsi que le chargement et l'évaluation du modèle enregistré.
